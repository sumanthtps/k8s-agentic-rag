...
# Lazy initialization - Ranker is loaded on first use to ensure lofire.configure() has run
_ranker = None
...
def rerank_documents(query: str, documents: list[str], top_n: int = 5) -> list[str]:
    ...
    Why Flashrank?
    Standard vector search (Cosine similarity) is fats but mathematically "fuzzy."
