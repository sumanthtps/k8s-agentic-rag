...
# Portkey expects a plain str | None for api_key. settings.PORTKEY_API_KEY is already
# str | None, so pass it directly to satisfy type checkers.
...
def get_langchain_llm(feature: str = "rag") -> ChatOpenAI:
    ...
    """
    return ChatOpenAI(
        api_key=settings.PORTKEY_API_KEY, # type: ignore
